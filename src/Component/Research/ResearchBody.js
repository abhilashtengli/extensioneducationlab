...
const ResearchBody = () => {
  return (
    <>
      <div>
        <div className=" flex flex-col justify-end pb-5 pl-6 lg:pl-44  border-red-500 text-teal-800 h-52">
        ...
        <div className="bg-teal-50 py-12 lg:px-0 px-5 lg:pl-44 lg:pr-32 border border-red-500  text-teal-800">
          <div>
