...
const ResearchBody = () => {
  return (
    <>
      <div>
        <div className=" flex flex-col justify-end pb-16 pl-6 lg:pl-44 border-red-500 text-teal-800 h-80">
        ...
        <div className="bg-teal-50 py-12 lg:px-0 px-5 lg:pl-44 lg:pr-32 border-t border-teal-100 text-teal-800">
          <DelayedComponent state="animate-bottom-to-top ">
            <p className="py-2 ">
              ...
              array of fields, reflecting his passion for interdisciplinary
              investigations. His primary research interests lie at the
              intersection of agriculture and nutrition, with a focus on
              enhancing agricultural practices to promote nutrition-sensitive
              outcomes. This entails not only optimizing crop production but
              also understanding the behavioural dynamics that underpin food
              choices and consumption patterns. Furthermore, he is deeply
              intrigued by the intricacies of entrepreneurship, particularly
              within the agricultural sector, where innovation and enterprise
              play pivotal roles in driving sustainable development.{" "}
            </p>
            <p className="py-2 ">
              In his investigations, Dr. Tengli employ sophisticated behavior
              modelling techniques to elucidate the decision-making processes of
              entrepreneurs and identify factors that influence their intentions
              and actions. Moreover, Dr. Tengli is captivated by the realm of
              psychometrics, employing quantitative methods to measure
              psychological constructs such as attitudes, beliefs, and
            ...
            <p className="py-2 ">
              ...
              Arunachal Pradesh, the entrepreneurial aspirations of students at
              Central Agricultural University, and the development of an
              ...
              meaningfully to the advancement of knowledge and the promotion of
              sustainable practices in agriculture and rural development.
            </p>
          </DelayedComponent>
        </div>
      </div>
