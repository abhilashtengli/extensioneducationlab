      ...
      <div className="border-red-500 w-[100%] px-2 lg:pt-24 pt-20  lg:flex">
        <div className="lg:w-4/6  border-black tracking-wider lg:px-5 ">
          <motion.p
            ...
            className="border text-teal-800 border-teal-500 text-justify lg:mt-2 mt-5 p-5 rounded-lg bg-teal-50 shadow-[0_20px_50px_hsl(180,_55%,_75%,_0.3)]"
          >
            <b className="text-lg">
        ...
        <div className=" lg:w-2/6  border-black  flex justify-center text-teal-800">
          <DelayedComponent state="animate-bottom-to-top">
            <div className="shadow-[0_20px_50px_hsl(180,_55%,_75%,_0.4)] mb-5 border border-teal-500 bg-teal-50 px-1 my-2 lg:mt-0 mt-5 rounded-lg w-fit py-1">
              <img
                className="lg:w-[21.2rem] w-[20.2rem]   border-red-500 rounded-tr-lg rounded-tl-lg"
                alt=""
                src={mbtengli}
              />
              ...
              <div className="mt-3 flex justify-center">
                <Link
                  to="/contact"
                  className=" animate-bottom-to-top px-4 py-1 rounded-md bg-teal-500 text-white font-bold transition duration-200 hover:bg-white hover:text-teal-800 border-transparent hover:border-teal-500  border-2  border-teal-600"
                >
                  Contact
                </Link>
              </div>
